...
```{r message=FALSE, comment= FALSE, warning=FALSE}
poll <- read.csv("https://raw.githubusercontent.com/Data607TidyVerse/master/approval_polllist%5B1%5D.csv", sep = ",", na.strings = "NA", strip.white = TRUE, stringsAsFactors = FALSE)
